...
CREATE TABLE `cadastro_voluntarios` (
  ...
  `descr_funcionamento` varchar(1500) NOT NULL,
  `nome` varchar(45) DEFAULT NULL,
  `tipo_ajuda` varchar(45) NOT NULL,
...
INSERT INTO `cadastro_voluntarios` VALUES (1,'atendimento psicologico uma vez por mes mediante cadastro','psicologa X','atendimento psicologico','9999','facebook'),(3,'12atendimento psicologico uma vez por mes mediante cadastro','psicologa X3123123','atendimento psicologico','9999','facebook');
...
-- Dump completed on 2019-10-10 18:06:48
