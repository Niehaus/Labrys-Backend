...
CREATE TABLE `rede_social` (
  `idrede_social` int(11) NOT NULL AUTO_INCREMENT,
  `twitter_user` varchar(45) DEFAULT NULL,
  `fb_link` varchar(45) DEFAULT NULL,
  `wpp_num` varchar(45) DEFAULT NULL,
...
INSERT INTO `rede_social` VALUES (1,'yayboechattata','bb','33'),(5,'yayboechat','bb','33'),(9,'dezaines','dd','24'),(10,'@aa','barbs.com','203'),(11,'@u','231','312312'),(12,'sadas','dasdas','dsdsa'),(13,'@yasmin','eqwoi2i','32099021'),(14,'fdsfda','fdad','fdaasd');
